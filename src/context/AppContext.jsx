...
export const AppProvider = ({children}) =>{
            ...
            .then(response => 
                {
                    ...
                    //setCurrentDataIcon(response.location);
    ...
    return < AppContext.Provider value={{daysWeek,dataLocation,currentData,currentDataIcon,forecast,dailyForecast}}>
             {children}
           </AppContext.Provider>
}